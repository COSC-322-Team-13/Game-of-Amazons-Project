...
public class CurrentBoard {
	...
	private ArrayList <ArrayList<Integer>> shotPos;
	
	public CurrentBoard() {
		shotPos = new ArrayList<ArrayList<Integer>>();
	...
	public ArrayList<ArrayList<Integer>> getAllShotPos(){
		
		return this.shotPos;
	}
	
	public void addShot(int y, int x) {
		ArrayList<Integer> newShot = new ArrayList<Integer>();
		newShot.add(y);
		newShot.add(x);
		shotPos.add(newShot);
	}
